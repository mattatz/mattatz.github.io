...
(function(global, THREE) {
    ...
    App.prototype = {
        ...
        init: function(id) {
            ...
            var textureIndex = 0;
            var textures = [
                THREE.ImageUtils.loadTexture("assets/textures/256x256/nevermind.jpg"),
                THREE.ImageUtils.loadTexture("assets/textures/256x256/jamesblake.jpg"),
                THREE.ImageUtils.loadTexture("assets/textures/256x256/mothersmilk.jpg"),
                THREE.ImageUtils.loadTexture("assets/textures/256x256/armyofme.jpg"),
                THREE.ImageUtils.loadTexture("assets/textures/256x256/seachange.jpg"),
                THREE.ImageUtils.loadTexture("assets/textures/256x256/thebends.jpg")
            ];
